    ...
    if opt['phase'] == 'train':
        ...
        for _,  val_data in enumerate(val_loader):
            ...
            if sr_img_mode == 'single':
                ...
                #     Metrics.save_img(
                #         Metrics.tensor2img(sr_img[iter]), '{}/{}_{}_sr_{}.png'.format(result_path, current_step, number, iter))
                Metrics.save_img(Metrics.tensor2img(sr_img[10]),'{}/{}_{}_sr.png'.format(result_path, current_step, number))
            else:
                # grid img
                sr_img = Metrics.tensor2img(visuals['SR'])  # uint8
                Metrics.save_img(
            ...
            Metrics.save_img(
                hr_img, '{}/{}_{}_hr.png'.format(result_path, current_step, number))
            Metrics.save_img(
